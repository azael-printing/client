...
//       { to: "/app/operator/queue", label: "Production Queue", icon: "queue" },
//       {
//         to: "/app/operator/in-production",
//         label: "In Production",
//         icon: "gear",
//       },
//       { to: "/app/operator/completed", label: "Completed", icon: "check" },
//       { to: "/app/operator/audit", label: "Audit Log", icon: "log" },
//     ],
//     [],
//   );
