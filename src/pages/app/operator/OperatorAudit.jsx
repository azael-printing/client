...
import { auditLog } from "../../api/operator.api";
...
export default function OperatorAudit() {
  ...
  return <AuditTable title="Operator Audit Log" err={err} rows={slice} page={pageSafe} totalPages={totalPages} onChange={setPage} onRefresh={load} />;
}
