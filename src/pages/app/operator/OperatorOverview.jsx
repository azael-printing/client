...
export default function OperatorOverview() {
  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
      <Card title="Total Jobs" value={stats.total} sub="Assigned/visible" />
      <Card title="Queue" value={stats.queue} sub="Pending / waiting" />
      <Card title="In Production" value={stats.inProd} sub="Active work" />
      <Card title="Completed" value={stats.done} sub="Production done" />
    </div>
  );
}
