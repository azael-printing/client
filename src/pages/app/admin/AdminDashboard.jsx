...
function Pill({ label, count }) {
  return (
    <div className="inline-flex items-center justify-between px-3 py-2 rounded-full bg-zinc-100 text-zinc-700 font-semibold text-xs sm:text-sm">
      ...
      <span className="ml-2 px-2 py-0.5 rounded-full bg-white border border-zinc-200 text-zinc-800 font-semibold text-xs">
        {count}
      </span>
    </div>
  );
...
function StatCard({ title, value, subtitle, onClick }) {
  return (
    ...
    >
      ...
      <div className="mt-2 text-primary text-2xl sm:text-3xl font-semibold tracking-tight">
        {value}
      </div>
...
export default function AdminDashboard() {
  ...
  return (
    <div className="grid gap-5">
      {/* <div> */}
      <h1 className="ml-5 text-primary font-semibold text-lg sm:text-xl">
        Quick Start{" "}
      </h1>
      ...
      <div className="bg-white border border-zinc-200 rounded-2xl p-5 shadow-sm">
        <div className="flex items-start justify-between gap-4">
          ...
          <button
            onClick={goAdminJobs}
            className="shrink-0 px-4 py-2 rounded-xl bg-primary text-white font-semibold hover:opacity-90 transition"
          >
          ...
          {machines.map((m) => (
            ...
            >
                ...
                {m.currentJob ? (
                  <div className="mt-2 grid gap-1 text-sm">
                    <div className="flex gap-2">
                      <span className="font-semibold text-zinc-700 w-[120px]">
                        Customer name
                      </span>
              ...
              <div className="mt-4 flex items-end justify-between">
                <div className="text-zinc-500 font-semibold">Pending Jobs</div>
