                    ...
                    <td className="py-2.5 px-3 whitespace-nowrap">
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="px-3 py-1.5 rounded-lg border border-primary/30 bg-white text-primary font-semibold transition-all duration-300 hover:-translate-y-0.5 hover:bg-bgLight hover:shadow-sm"
                        >
                          Edit
                        </button>
                        <button
                          ...
                          className="px-3 py-1.5 rounded-lg border border-red-300 bg-white text-red-600 font-semibold transition-all duration-300 hover:-translate-y-0.5 hover:bg-red-50 hover:text-white hover:shadow-sm"
                        >
                          Delete
                        </button>
                      </div>
