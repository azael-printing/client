// JOB LIST (corrected + Cancel modal below Update)
...
export default function JobsList() {
  ...
  // cancel modal state (correct names!)
  ...
  return (
    <div className="grid gap-4 lg:grid-cols-[1fr_320px]">
      {/* LEFT */}
      <div className="bg-white border border-zinc-200 rounded-2xl p-6 shadow-sm w-fit">
          ...
          <div className="grid gap-3">
            ...
            {(role === "ADMIN" || role === "CS") && (
              <button
                ...
                className="px-4 py-3 rounded-xl bg-danger text-white font-extrabold hover:opacity-90 transition"
              >
                Cancel Job
              </button>
            )}
